...
1. In xMatters, go to the _Developer_ tab and then select **Event Domains** from the left hand menu.
...
1. In xMatters, go to the _Developer_ tab and click **Import Plan**.
